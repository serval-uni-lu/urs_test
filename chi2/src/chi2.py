...
parser.add_argument("-b", "--batch_size", type=int, default=1000, help="set the batch size, i.e. the number of solutions asked to the sampler. If it is k<0 then it is converted to abs(k) * #models of formula")
